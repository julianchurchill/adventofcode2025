...
public class JoltageTests
{
    ...
    public void FindTotalJoltage()
    {
        ...
        // part 1
        Console.WriteLine($"part 1 total joltage = {input.Sum(batteryBank => long.Parse(JoltageCalculator.CalculateMaxJoltage(batteryBank)))}");
        // part 2
        Console.WriteLine($"part 2 total joltage = {input.Sum(batteryBank => long.Parse(JoltageCalculator.CalculateMaxJoltage2(batteryBank, 12)))}");
    }
    ...
    [TestCase("234234234234278", "434234234278", 12)]
    [TestCase("7364324241225433445422232322233434224835321253334532333323166227675321322533332522422446233324232434", "8776", 4)]
    ...
    [TestCase("21", "21", 2)]
    [TestCase("11", "11", 2)]
    [TestCase("18798", "8798", 4)]
    [TestCase("218798", "28798", 5)]
